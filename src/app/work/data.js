export const EXPERIENCE = [
  {
    ...
    stack: ["Power BI", "Excel", "Databricks", "Power Automate", "Manufacturing Systems", "JSON"],
    narrative: "Joined GM as a production Group Leader on the manufacturing floor, then moved into Digital Enablement and Continuous Improvement, where I now build the tooling that other Group Leaders use day-to-day. Working with data from Databricks, and operational systems, I design custom Power BI dashboards and Power Automate flows that turn manual reporting into automated insight.",
    bullets: [
      "Leading teams consisting of 20-35 people, and Safety, People, Quality, Responsiveness and Cost (SPQRC) across the floor.",
      "Built fully custom Power BI reports using JSON for line layouts as seen in person and DAX for measures, replacing manual spreadsheet workflows used across multiple shifts with scheduled automations.",
      ...
      "Automated cost report from manual entry to Power BI, with a difference of $2 in $1.2M reported cost.",
    ],
    links: [],
  },
  {
